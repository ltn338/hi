...
module.exports.handleEvent = async ({ event, api, Users, Threads }) => {
  ...
  // Ban logic
  const arr = ["Admin lol", "Admin lồn", "Admin gà", "con Admin lol", "Admin ngu lol", "Admin chó", "dm Admin", "đm Admin", "dmm Admin", "dmm Admin", "đmm Admin", "đb Admin", "Admin điên", "Admin dở", "Admin khùng", "đĩ Admin", "Admin paylac rồi", "con Admin lòn", "cmm Admin", "clap Admin", "Admin ncc", "Admin oc", "Admin óc", "Admin óc chó", "cc Admin", "Admin tiki", "lozz Admintt", "lol Admin", "loz Admin", "lồn Admin", "Admin lồn", "Admin lon", "Admin cac", "Admin nhu lon", "Admin như cc", "Admin như bìu", "Admin sida", "Admin sida", "Admin fake", "nghĩa ngu", "Admin shoppee","Admin đểu", "Admin dỡm"];
  arr.forEach(async i => {
